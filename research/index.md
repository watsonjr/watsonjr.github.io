...
### Insurance in Marine Social-Ecological Systems
We are interested in thinking outside the box in terms of what tools can be used for developing sustainable marine social-ecological systems. In particular we are exploring the role that novel insurance policies might be able to incentivize best management practices by both fishers and aquaculturalists. These include ocean-index based insurance schemes, p2p insurance, and using Blockchain technology.
